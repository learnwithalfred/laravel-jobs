...
<div class="sm:px-4" style="min-height: 66vh;">
  <div class="mx-auto max-w-3xl p-4 my-8 border border-gray-200 rounded-lg shadow sm:p-8">
    ...
    <div class="flex">
      ...
      <span
        class="py-2.5 px-4 mr-2 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 inline-flex items-center">
    ...
    <div class="text-sm text-gray-600 py-6">
      If you are a Project Manager with 5+ years of experience, please read on! Top Reasons to Work with Us We
      founded
      our company on the core ideal that properly executed, deadline-based operations keep cr...
    </div>
    <button type="button"
      class="inline-flex items-center text-gray-900 text-2xl bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 rounded-full px-6 py-4 mr-2 mb-2 ">
      <span class="px-2">
        Apply Now
      </span>
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
